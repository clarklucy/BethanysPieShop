...
namespace BethanysPieShop.Models
{
    public class MockPieRepository : IPieRepository
        /*The MockPieRepository is a mock implementation of the IPieRepository interface methods.
          It creates some "mock"/none database Pie/domain data to ensure the methods are functioning and implemented correctly.
          The advantage being that you do not need a database for testing... as well as other things!*/
    {
        private readonly ICategoryRepository _categoryRepository = new MockCategoryRepository();
        //this is a hard-coded category repository instance, required for making the MockPieRepository work
        public IEnumerable<Pie> AllPies =>
            new List<Pie>
            {
                //hard-coded data to test without database
